...
L4:
	...
	%r8 = getelementptr %struct.IntList* %r7, i1 0, i32 0
	%r9 = load i32* %next
	store i32 %r9, i32* %r8
	%r10 = load %struct.IntList** %list
	%r11 = getelementptr %struct.IntList* %r10, i1 0, i32 1
...
L5:
	...
	%r15 = getelementptr %struct.IntList* %r14, i1 0, i32 0
	%r16 = load i32* %next
	store i32 %r16, i32* %r15
	%r17 = load %struct.IntList** %list
	%r18 = getelementptr %struct.IntList* %r17, i1 0, i32 1
...
L6:
	br label %L3
L3:
	%r13 = load %struct.IntList** %_retval_
...
L18:
	...
	%r32 = getelementptr %struct.IntList* %r31, i1 0, i32 0
	%r33 = load i32* %r32
	store i32 %r33, i32* %big
	%r42 = load %struct.IntList** %list
	%r43 = getelementptr %struct.IntList* %r42, i1 0, i32 1
...
L20:
	...
	%r36 = getelementptr %struct.IntList* %r35, i1 0, i32 0
	%r37 = load i32* %r36
	%r38 = call i32 @biggest(i32 %r34, i32 %r37 )
	store i32 %r38, i32* %big
	%r39 = load %struct.IntList** %list
	%r40 = getelementptr %struct.IntList* %r39, i1 0, i32 1
	%r41 = load %struct.IntList** %r40
	store %struct.IntList* %r41, %struct.IntList** %list
	%r48 = load %struct.IntList** %list
	%r49 = getelementptr %struct.IntList* %r48, i1 0, i32 1
	%r50 = load %struct.IntList** %r49
