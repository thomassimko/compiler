...
L2:
	...
	%r12 = load %struct.node** %n0
	%r13 = getelementptr %struct.node* %r12, i1 0, i32 1
	call i32 (i8*, ...)* @scanf(i8* getelementptr inbounds ([4 x i8]* @.read, i32 0, i32 0), i32* %r13)
	%r14 = load %struct.node** %n1
	%r15 = getelementptr %struct.node* %r14, i1 0, i32 1
	call i32 (i8*, ...)* @scanf(i8* getelementptr inbounds ([4 x i8]* @.read, i32 0, i32 0), i32* %r15)
	%r16 = load %struct.node** %n2
	%r17 = getelementptr %struct.node* %r16, i1 0, i32 1
	call i32 (i8*, ...)* @scanf(i8* getelementptr inbounds ([4 x i8]* @.read, i32 0, i32 0), i32* %r17)
	%r18 = load %struct.node** %n3
	%r19 = getelementptr %struct.node* %r18, i1 0, i32 1
	call i32 (i8*, ...)* @scanf(i8* getelementptr inbounds ([4 x i8]* @.read, i32 0, i32 0), i32* %r19)
	%r20 = load %struct.node** %n4
	%r21 = getelementptr %struct.node* %r20, i1 0, i32 1
	call i32 (i8*, ...)* @scanf(i8* getelementptr inbounds ([4 x i8]* @.read, i32 0, i32 0), i32* %r21)
	%r22 = load %struct.node** %n5
	%r23 = getelementptr %struct.node* %r22, i1 0, i32 1
	call i32 (i8*, ...)* @scanf(i8* getelementptr inbounds ([4 x i8]* @.read, i32 0, i32 0), i32* %r23)
	%r24 = load %struct.node** %n0
	%r25 = getelementptr %struct.node* %r24, i1 0, i32 0
	%r26 = load %struct.node** %n1
	store %struct.node* %r26, %struct.node** %r25
	%r27 = load %struct.node** %n1
	%r28 = getelementptr %struct.node* %r27, i1 0, i32 0
	%r29 = load %struct.node** %n2
	store %struct.node* %r29, %struct.node** %r28
	%r30 = load %struct.node** %n2
	%r31 = getelementptr %struct.node* %r30, i1 0, i32 0
	%r32 = load %struct.node** %n3
	store %struct.node* %r32, %struct.node** %r31
	%r33 = load %struct.node** %n3
	%r34 = getelementptr %struct.node* %r33, i1 0, i32 0
	%r35 = load %struct.node** %n4
	store %struct.node* %r35, %struct.node** %r34
	%r36 = load %struct.node** %n4
	%r37 = getelementptr %struct.node* %r36, i1 0, i32 0
	%r38 = load %struct.node** %n5
	store %struct.node* %r38, %struct.node** %r37
	%r39 = load %struct.node** %n5
	%r40 = getelementptr %struct.node* %r39, i1 0, i32 0
	store %struct.node* null, %struct.node** %r40
	%r41 = load %struct.node** %n0
	store %struct.node* %r41, %struct.node** %_retval_
	br label %L3
L3:
	%r42 = load %struct.node** %_retval_
	ret %struct.node* %r42
}
...
L5:
	...
	store i32 0, i32* %i
	%r43 = load %struct.node** %list
	store %struct.node* %r43, %struct.node** %cur
	%r44 = load %struct.node** %cur
	%r45 = getelementptr %struct.node* %r44, i1 0, i32 1
	%r46 = load i32* %r45
	store i32 %r46, i32* %product
	%r47 = load %struct.node** %cur
	%r48 = getelementptr %struct.node* %r47, i1 0, i32 0
...
L7:
	%r50 = load i32* %product
	%r51 = load %struct.node** %cur
	%r52 = getelementptr %struct.node* %r51, i1 0, i32 1
	%r53 = load i32* %r52
	%r54 = mul i32 %r50, %r53
	store i32 %r54, i32* %product
	%r55 = load %struct.node** %cur
	%r56 = getelementptr %struct.node* %r55, i1 0, i32 0
	%r57 = load %struct.node** %r56
	store %struct.node* %r57, %struct.node** %cur
	%r58 = load i32* %product
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r58)
	%r59 = load i32* %i
	%r60 = add i32 %r59, 1
	store i32 %r60, i32* %i
	%r65 = load i32* %i
...
L10:
	...
	%cur = alloca %struct.node*
	store i32 0, i32* %i
	%r71 = load %struct.node** %list
	store %struct.node* %r71, %struct.node** %cur
	%r72 = load %struct.node** %cur
	%r73 = getelementptr %struct.node* %r72, i1 0, i32 1
	%r74 = load i32* %r73
	store i32 %r74, i32* %sum
	%r75 = load %struct.node** %cur
	%r76 = getelementptr %struct.node* %r75, i1 0, i32 0
	...
	br i1 %r92, label %L12, label %L13

L12:
	%r78 = load i32* %sum
	%r79 = load %struct.node** %cur
	%r80 = getelementptr %struct.node* %r79, i1 0, i32 1
	%r81 = load i32* %r80
	%r82 = add i32 %r78, %r81
	store i32 %r82, i32* %sum
	%r83 = load %struct.node** %cur
	%r84 = getelementptr %struct.node* %r83, i1 0, i32 0
	%r85 = load %struct.node** %r84
	store %struct.node* %r85, %struct.node** %cur
	%r86 = load i32* %sum
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r86)
	%r87 = load i32* %i
	%r88 = add i32 %r87, 1
	store i32 %r88, i32* %i
	%r93 = load i32* %i
...
L15:
	...
	%r100 = getelementptr %struct.node* %r99, i1 0, i32 0
	%r101 = load %struct.node** %r100
	%r102 = icmp eq %struct.node* %r101, null
	%r103 = zext i1 %r102 to i32
	%r104 = trunc i32 %r103 to i1
	br i1 %r104, label %L17, label %L18

L17:
	%r105 = load %struct.node** %list
	%r106 = getelementptr %struct.node* %r105, i1 0, i32 1
	%r107 = load i32* %r106
	store i32 %r107, i32* %_retval_
	br label %L16
L18:
	%r109 = load %struct.node** %list
	%r110 = getelementptr %struct.node* %r109, i1 0, i32 1
	%r111 = load i32* %r110
	%r112 = load %struct.node** %list
	%r113 = getelementptr %struct.node* %r112, i1 0, i32 0
	%r114 = load %struct.node** %r113
...
L25:
	...
	br i1 %r140, label %L25, label %L26

L26:
	%r141 = load i32* %bigProduct
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r141)
	%r144 = load i32* %bigProduct
	%r145 = icmp ne i32 %r144, 0
	%r146 = zext i1 %r145 to i32
	%r147 = trunc i32 %r146 to i1
	br i1 %r147, label %L27, label %L28

L27:
	%r142 = load i32* %bigProduct
	%r143 = sub i32 %r142, 1
	store i32 %r143, i32* %bigProduct
	%r148 = load i32* %bigProduct
	%r149 = icmp ne i32 %r148, 0
	%r150 = zext i1 %r149 to i32
	%r151 = trunc i32 %r150 to i1
	br i1 %r151, label %L27, label %L28

L28:
	%r152 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r152)
	%r153 = load i32* %bigProduct
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r153)
	store i32 0, i32* %_retval_
	br label %L24
L24:
	%r154 = load i32* %_retval_
	ret i32 %r154
}
