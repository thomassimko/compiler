...
L20:
	%r87 = call %struct.node* @buildList()
	%r88 = call i32 @multiple(%struct.node* %r87 )
	%r89 = call i32 @add(%struct.node* %r87 )
	%r90 = sdiv i32 %r89, 2
	%r91 = sub i32 %r88, %r90
	%r92 = icmp slt i32 0, 2
...
L22:
	...
	%r96 = phi %struct.node* [%r87, %L20], [%r96, %L22]
