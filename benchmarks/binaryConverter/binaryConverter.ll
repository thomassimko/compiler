...
L4:
	%r0 = load i32* %waitTime
	%r1 = sub i32 %r0, 1
	store i32 %r1, i32* %waitTime
	%r6 = load i32* %waitTime
...
L9:
	%r11 = load i32* %product
	%r12 = load i32* %base
	%r13 = mul i32 %r11, %r12
	store i32 %r13, i32* %product
	%r14 = load i32* %exponent
	%r15 = sub i32 %r14, 1
	store i32 %r15, i32* %exponent
	%r20 = load i32* %exponent
...
L10:
	%r24 = load i32* %product
	store i32 %r24, i32* %_retval_
	br label %L8
L8:
	%r25 = load i32* %_retval_
	ret i32 %r25
}
...
L14:
	...
	%r30 = load i32* %binaryNum
	%r31 = sdiv i32 %r30, 10
	store i32 %r31, i32* %tempNum
	%r32 = load i32* %tempNum
	%r33 = mul i32 %r32, 10
	store i32 %r33, i32* %tempNum
	%r34 = load i32* %binaryNum
	%r35 = load i32* %tempNum
	%r36 = sub i32 %r34, %r35
	store i32 %r36, i32* %tempNum
	%r37 = load i32* %tempNum
...
L15:
	br label %L16
L16:
	%r53 = load i32* %decimalSum
	store i32 %r53, i32* %_retval_
	br label %L13
L17:
	%r41 = load i32* %decimalSum
	%r42 = load i32* %base
	%r43 = load i32* %recursiveDepth
...
L18:
	br label %L19
L19:
	%r46 = load i32* %binaryNum
	%r47 = sdiv i32 %r46, 10
	%r48 = load i32* %decimalSum
	%r49 = load i32* %recursiveDepth
	%r50 = add i32 %r49, 1
	%r51 = call i32 @recursiveDecimalSum(i32 %r47, i32 %r48, i32 %r50 )
	store i32 %r51, i32* %_retval_
	br label %L13
L13:
	%r52 = load i32* %_retval_
	ret i32 %r52
}
...
L22:
	...
	%r55 = load i32* %binaryNum
	%r56 = load i32* %decimalSum
	%r57 = load i32* %recursiveDepth
	%r58 = call i32 @recursiveDecimalSum(i32 %r55, i32 %r56, i32 %r57 )
	store i32 %r58, i32* %_retval_
	br label %L23
L23:
	%r59 = load i32* %_retval_
	ret i32 %r59
}
...
L25:
	...
	%number = alloca i32
	%waitTime = alloca i32
	call i32 (i8*, ...)* @scanf(i8* getelementptr inbounds ([4 x i8]* @.read, i32 0, i32 0), i32* %number)
	%r60 = load i32* %number
...
L27:
	%r65 = load i32* %waitTime
	call i32 @wait(i32 %r65 )
	%r66 = load i32* %waitTime
	%r67 = sub i32 %r66, 1
	store i32 %r67, i32* %waitTime
	%r72 = load i32* %waitTime
...
L28:
	%r76 = load i32* %number
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r76)
	store i32 0, i32* %_retval_
	br label %L26
L26:
	%r77 = load i32* %_retval_
	ret i32 %r77
}
