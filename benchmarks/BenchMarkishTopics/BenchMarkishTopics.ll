...
L5:
	br label %L6
L6:
	%r5 = load %struct.intList** %list
	%r6 = getelementptr %struct.intList* %r5, i1 0, i32 1
	%r7 = load %struct.intList** %r6
...
L11:
	...
	%r18 = getelementptr %struct.intList* %r17, i1 0, i32 0
	%r19 = load i32* %element
	store i32 %r19, i32* %r18
	%r20 = load %struct.intList** %list
	%r21 = getelementptr %struct.intList* %r20, i1 0, i32 1
	store %struct.intList* null, %struct.intList** %r21
	%r22 = load %struct.intList** %list
...
L13:
	...
	%r26 = load %struct.intList** %front
	%r27 = getelementptr %struct.intList* %r26, i1 0, i32 0
	%r28 = load i32* %element
	store i32 %r28, i32* %r27
	%r29 = load %struct.intList** %front
	%r30 = getelementptr %struct.intList* %r29, i1 0, i32 1
	%r31 = load %struct.intList** %list
	store %struct.intList* %r31, %struct.intList** %r30
	%r32 = load %struct.intList** %front
	store %struct.intList* %r32, %struct.intList** %_retval_
	br label %L10
L10:
	%r23 = load %struct.intList** %_retval_
...
L19:
	br label %L20
L20:
	%r39 = load %struct.intList** %list
	store %struct.intList* %r39, %struct.intList** %first
	%r40 = load %struct.intList** %list
	%r41 = getelementptr %struct.intList* %r40, i1 0, i32 1
	%r42 = load %struct.intList** %r41
	store %struct.intList* %r42, %struct.intList** %list
	%r44 = load %struct.intList** %first
	...
	br label %L17
L17:
	%r38 = load %struct.intList** %_retval_
...
L25:
	%r47 = load %struct.intList** %list
	%r48 = load i32* @intList
	%r49 = call %struct.intList* @addToFront(%struct.intList* %r47, i32 %r48 )
	store %struct.intList* %r49, %struct.intList** %list
	%r50 = load %struct.intList** %list
	%r51 = getelementptr %struct.intList* %r50, i1 0, i32 0
	%r52 = load i32* %r51
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.print, i32 0, i32 0), i32 %r52)
	%r53 = load i32* @intList
	%r54 = sub i32 %r53, 1
	store i32 %r54, i32* @intList
	%r59 = load i32* @intList
...
L26:
	%r63 = load %struct.intList** %list
	%r64 = call i32 @length(%struct.intList* %r63 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.print, i32 0, i32 0), i32 %r64)
	%r74 = load %struct.intList** %list
...
L28:
	%r84 = load i32* %sum
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r84)
	store i32 0, i32* %_retval_
	br label %L24
L24:
	%r85 = load i32* %_retval_
	ret i32 %r85
}
