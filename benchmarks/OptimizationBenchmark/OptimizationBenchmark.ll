...
L80:
	%r606 = load i32* %result
	%r607 = load i32* %previous
	%r608 = add i32 %r606, %r607
	store i32 %r608, i32* %sum
	%r609 = load i32* %result
...
L81:
	%r623 = load i32* %result
	store i32 %r623, i32* %_retval_
	br label %L79
L79:
	%r624 = load i32* %_retval_
	ret i32 %r624
}
...
L93:
	...
	%r644 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r644)
	%r645 = call i32 @constantPropagation()
	store i32 %r645, i32* %result
	%r646 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r646)
	%r647 = call i32 @deadCodeElimination()
	store i32 %r647, i32* %result
	%r648 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r648)
	%r649 = call i32 @interProceduralOptimization()
	store i32 %r649, i32* %result
	%r650 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r650)
	%r651 = call i32 @commonSubexpressionElimination()
	store i32 %r651, i32* %result
	%r652 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r652)
	%r653 = call i32 @hoisting()
	store i32 %r653, i32* %result
	%r654 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r654)
	%r655 = call i32 @doubleIf()
	store i32 %r655, i32* %result
	%r656 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r656)
	%r657 = call i32 @integerDivide()
	store i32 %r657, i32* %result
	%r658 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r658)
	%r659 = call i32 @association()
	store i32 %r659, i32* %result
	%r660 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r660)
	%r661 = load i32* %input
	%r662 = sdiv i32 %r661, 1000
	%r663 = call i32 @tailRecursion(i32 %r662 )
	store i32 %r663, i32* %result
	%r664 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r664)
	%r665 = call i32 @unswitching()
	store i32 %r665, i32* %result
	%r666 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r666)
	%r667 = load i32* %input
	%r668 = call i32 @randomCalculation(i32 %r667 )
	store i32 %r668, i32* %result
	%r669 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r669)
	%r670 = load i32* %input
	%r671 = sdiv i32 %r670, 5
	%r672 = call i32 @iterativeFibonacci(i32 %r671 )
	store i32 %r672, i32* %result
	%r673 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r673)
	%r674 = load i32* %input
	%r675 = sdiv i32 %r674, 1000
	%r676 = call i32 @recursiveFibonacci(i32 %r675 )
	store i32 %r676, i32* %result
	%r677 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r677)
	%r678 = load i32* %i
	%r679 = add i32 %r678, 1
