...
L7:
	...
	%r17 = load %struct.Power** %power
	%r18 = getelementptr %struct.Power* %r17, i1 0, i32 0
	%r19 = load i32* %input
...
L10:
	br label %L11
L11:
	%r26 = load %struct.Power** %power
	%r27 = getelementptr %struct.Power* %r26, i1 0, i32 1
	%r28 = load i32* %input
...
L13:
	...
	%r32 = getelementptr %struct.Power* %r31, i1 0, i32 0
	%r33 = load i32* %r32
	%r34 = load %struct.Power** %power
	%r35 = getelementptr %struct.Power* %r34, i1 0, i32 1
	%r36 = load i32* %r35
...
L14:
	%r46 = load i32* %result
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r46)
