...
L5:
	...
	%r11 = getelementptr %struct.IntHolder , %struct.IntHolder* %r10, i1 0, i32 0
...
L8:
	...
	%r23 = load %struct.IntHolder*, %struct.IntHolder** %num
	%r24 = getelementptr %struct.IntHolder , %struct.IntHolder* %r23, i1 0, i32 0
	...
	%r29 = load %struct.IntHolder*, %struct.IntHolder** %num
	%r30 = getelementptr %struct.IntHolder , %struct.IntHolder* %r29, i1 0, i32 0
	...
	%r35 = load %struct.IntHolder*, %struct.IntHolder** %num
	%r36 = getelementptr %struct.IntHolder , %struct.IntHolder* %r35, i1 0, i32 0
...
L11:
	...
	call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.read, i32 0, i32 0), i32* %start)
	call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.read, i32 0, i32 0), i32* @interval)
	%r41 = load i32, i32* %start
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r41)
	%r42 = load i32, i32* @interval
...
L17:
	...
	%r80 = load i32, i32* %countInner
	%r81 = load i32, i32* @end
...
L14:
	...
	%r53 = load i32, i32* %countInner
	%r54 = add i32 %r53, 1
	store i32 %r54, i32* %countInner
	%r55 = load %struct.IntHolder*, %struct.IntHolder** %x
	%r56 = getelementptr %struct.IntHolder , %struct.IntHolder* %r55, i1 0, i32 0
	%r57 = load i32, i32* %countInner
	store i32 %r57, i32* %r56
	%r58 = load %struct.IntHolder*, %struct.IntHolder** %x
	%r59 = getelementptr %struct.IntHolder , %struct.IntHolder* %r58, i1 0, i32 0
	%r60 = load i32, i32* %r59
	store i32 %r60, i32* %tempAnswer
	%r61 = load %struct.IntHolder*, %struct.IntHolder** %x
	call i32 @multBy4xTimes(%struct.IntHolder* %r61, i32 2 )
	%r62 = load %struct.IntHolder*, %struct.IntHolder** %x
	call void @divideBy8(%struct.IntHolder* %r62 )
	%r63 = load i32, i32* @interval
	%r64 = sub i32 %r63, 1
	store i32 %r64, i32* %tempInterval
	%r65 = load i32, i32* %tempInterval
	%r66 = icmp sle i32 %r65, 0
	%r67 = zext i1 %r66 to i32
	store i32 %r67, i32* %uselessVar
	%r68 = load i32, i32* %tempInterval
