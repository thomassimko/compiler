...
L14:
	...
	br label %L15
L15:
	%r10 = load %struct.thing*, %struct.thing** %s
	%r11 = getelementptr %struct.thing , %struct.thing* %r10, i1 0, i32 0
...
L23:
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.print, i32 0, i32 0), i32 0)
	%r18 = load i32, i32* %a5
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r18)
	br label %L24
L24:
	%r19 = load i32, i32* %a6
...
L35:
	...
	%r34 = load i32, i32* %ret
	store i32 %r34, i32* %_retval_
	br label %L36
L36:
	%r35 = load i32, i32* %_retval_
	ret i32 %r35
}
...
L38:
	...
	%ret = alloca i32
	store i32 %_P_ret, i32* %ret
	%r36 = load i32, i32* %ret
	store i32 %r36, i32* %_retval_
	br label %L39
L39:
	%r37 = load i32, i32* %_retval_
	ret i32 %r37
}
...
L41:
	...
	%r38 = load %struct.thing*, %struct.thing** %ret
	store %struct.thing* %r38, %struct.thing** %_retval_
	br label %L42
L42:
	%r39 = load %struct.thing*, %struct.thing** %_retval_
...
L107:
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.print, i32 0, i32 0), i32 0)
	%r128 = mul i32 2, 3
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r128)
	br label %L108
L108:
	%r129 = sub i32 3, 2
...
L110:
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.print, i32 0, i32 0), i32 0)
	%r133 = sub i32 3, 2
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r133)
	br label %L111
L111:
	%r134 = sdiv i32 6, 3
...
L120:
	store i32 3, i32* %i1
	store i32 2, i32* %i2
	%r147 = load i32, i32* %i1
	%r148 = load i32, i32* %i2
	%r149 = add i32 %r147, %r148
	store i32 %r149, i32* %i3
	%r150 = load i32, i32* %i3
...
L141:
	br label %L142
L142:
	%r172 = load i32, i32* %i1
	%r173 = add i32 %r172, 5
	store i32 %r173, i32* %i1
	%r178 = load i32, i32* %i1
...
L145:
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.print, i32 0, i32 0), i32 0)
	%r186 = load i32, i32* %i1
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r186)
	br label %L146
L146:
	...
	%r189 = load %struct.thing*, %struct.thing** %s1
	%r190 = getelementptr %struct.thing , %struct.thing* %r189, i1 0, i32 1
	store i32 42, i32* %r190
	%r191 = load %struct.thing*, %struct.thing** %s1
	%r192 = getelementptr %struct.thing , %struct.thing* %r191, i1 0, i32 0
	%r193 = zext i1 1 to i32
	store i32 %r193, i32* %r192
	%r194 = load %struct.thing*, %struct.thing** %s1
	%r195 = getelementptr %struct.thing , %struct.thing* %r194, i1 0, i32 1
...
L148:
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.print, i32 0, i32 0), i32 0)
	%r200 = load %struct.thing*, %struct.thing** %s1
	%r201 = getelementptr %struct.thing , %struct.thing* %r200, i1 0, i32 1
	%r202 = load i32, i32* %r201
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r202)
	br label %L149
L149:
	%r203 = load %struct.thing*, %struct.thing** %s1
...
L151:
	...
	br label %L152
L152:
	%r207 = load %struct.thing*, %struct.thing** %s1
	%r208 = getelementptr %struct.thing , %struct.thing* %r207, i1 0, i32 2
	%r209 = call i8* @malloc(i32 24)
	%r210 = bitcast i8* %r209 to %struct.thing*
	store %struct.thing* %r210, %struct.thing** %r208
	%r211 = load %struct.thing*, %struct.thing** %s1
	%r212 = getelementptr %struct.thing , %struct.thing* %r211, i1 0, i32 2
	%r213 = load %struct.thing*, %struct.thing** %r212
	%r214 = getelementptr %struct.thing , %struct.thing* %r213, i1 0, i32 1
	store i32 13, i32* %r214
	%r215 = load %struct.thing*, %struct.thing** %s1
	%r216 = getelementptr %struct.thing , %struct.thing* %r215, i1 0, i32 2
	%r217 = load %struct.thing*, %struct.thing** %r216
	%r218 = getelementptr %struct.thing , %struct.thing* %r217, i1 0, i32 0
	%r219 = zext i1 0 to i32
	store i32 %r219, i32* %r218
	%r220 = load %struct.thing*, %struct.thing** %s1
	%r221 = getelementptr %struct.thing , %struct.thing* %r220, i1 0, i32 2
	%r222 = load %struct.thing*, %struct.thing** %r221
	%r223 = getelementptr %struct.thing , %struct.thing* %r222, i1 0, i32 1
...
L154:
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.print, i32 0, i32 0), i32 0)
	%r228 = load %struct.thing*, %struct.thing** %s1
	...
	br label %L155
L155:
	%r233 = load %struct.thing*, %struct.thing** %s1
	%r234 = getelementptr %struct.thing , %struct.thing* %r233, i1 0, i32 2
	%r235 = load %struct.thing*, %struct.thing** %r234
	%r236 = getelementptr %struct.thing , %struct.thing* %r235, i1 0, i32 0
...
L157:
	...
	br label %L158
L158:
	%r240 = load %struct.thing*, %struct.thing** %s1
	%r241 = load %struct.thing*, %struct.thing** %s1
...
L160:
	...
	br label %L161
L161:
	%r245 = load %struct.thing*, %struct.thing** %s1
	%r246 = load %struct.thing*, %struct.thing** %s1
	%r247 = getelementptr %struct.thing , %struct.thing* %r246, i1 0, i32 2
	%r248 = load %struct.thing*, %struct.thing** %r247
...
L163:
	...
	br label %L164
L164:
	%r253 = load %struct.thing*, %struct.thing** %s1
...
L170:
	...
	%r268 = load %struct.thing*, %struct.thing** @gs1
	%r269 = getelementptr %struct.thing , %struct.thing* %r268, i1 0, i32 1
	store i32 34, i32* %r269
	%r270 = load %struct.thing*, %struct.thing** @gs1
	%r271 = getelementptr %struct.thing , %struct.thing* %r270, i1 0, i32 0
	%r272 = zext i1 0 to i32
	store i32 %r272, i32* %r271
	%r273 = load %struct.thing*, %struct.thing** @gs1
	%r274 = getelementptr %struct.thing , %struct.thing* %r273, i1 0, i32 1
...
L172:
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.print, i32 0, i32 0), i32 0)
	%r279 = load %struct.thing*, %struct.thing** @gs1
	%r280 = getelementptr %struct.thing , %struct.thing* %r279, i1 0, i32 1
	%r281 = load i32, i32* %r280
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r281)
	br label %L173
L173:
	%r282 = load %struct.thing*, %struct.thing** @gs1
	%r283 = getelementptr %struct.thing , %struct.thing* %r282, i1 0, i32 0
...
L176:
	...
	%r288 = getelementptr %struct.thing , %struct.thing* %r287, i1 0, i32 2
	...
	%r292 = getelementptr %struct.thing , %struct.thing* %r291, i1 0, i32 2
	%r293 = load %struct.thing*, %struct.thing** %r292
	%r294 = getelementptr %struct.thing , %struct.thing* %r293, i1 0, i32 1
	store i32 16, i32* %r294
	%r295 = load %struct.thing*, %struct.thing** @gs1
	%r296 = getelementptr %struct.thing , %struct.thing* %r295, i1 0, i32 2
	%r297 = load %struct.thing*, %struct.thing** %r296
	%r298 = getelementptr %struct.thing , %struct.thing* %r297, i1 0, i32 0
	%r299 = zext i1 1 to i32
	store i32 %r299, i32* %r298
	%r300 = load %struct.thing*, %struct.thing** @gs1
	%r301 = getelementptr %struct.thing , %struct.thing* %r300, i1 0, i32 2
	%r302 = load %struct.thing*, %struct.thing** %r301
	%r303 = getelementptr %struct.thing , %struct.thing* %r302, i1 0, i32 1
...
L178:
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.print, i32 0, i32 0), i32 0)
	%r308 = load %struct.thing*, %struct.thing** @gs1
	%r309 = getelementptr %struct.thing , %struct.thing* %r308, i1 0, i32 2
	%r310 = load %struct.thing*, %struct.thing** %r309
	%r311 = getelementptr %struct.thing , %struct.thing* %r310, i1 0, i32 1
	%r312 = load i32, i32* %r311
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r312)
	br label %L179
L179:
	%r313 = load %struct.thing*, %struct.thing** @gs1
	%r314 = getelementptr %struct.thing , %struct.thing* %r313, i1 0, i32 2
	%r315 = load %struct.thing*, %struct.thing** %r314
	%r316 = getelementptr %struct.thing , %struct.thing* %r315, i1 0, i32 0
...
L182:
	...
	%r321 = getelementptr %struct.thing , %struct.thing* %r320, i1 0, i32 2
	%r322 = load %struct.thing*, %struct.thing** %r321
	%r319 = bitcast %struct.thing* %r322 to i8*
	call void @free(i8* %r319 )
	%r324 = load %struct.thing*, %struct.thing** @gs1
	...
	%r327 = load %struct.thing*, %struct.thing** %s1
	%r328 = getelementptr %struct.thing , %struct.thing* %r327, i1 0, i32 0
	%r329 = zext i1 1 to i32
	store i32 %r329, i32* %r328
	%r330 = zext i1 1 to i32
	%r331 = load %struct.thing*, %struct.thing** %s1
...
L184:
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.print, i32 0, i32 0), i32 0)
	%r337 = load i32, i32* %i1
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r337)
	br label %L185
L185:
	%r338 = zext i1 1 to i32
	%r339 = call i32 @returnbool(i32 %r338 )
	store i32 %r339, i32* %b1
	%r340 = load i32, i32* %b1
...
L188:
	...
	%r344 = load %struct.thing*, %struct.thing** %s1
	%r345 = call %struct.thing* @returnstruct(%struct.thing* %r344 )
	store %struct.thing* %r345, %struct.thing** %s2
	%r346 = load %struct.thing*, %struct.thing** %s1
	%r347 = load %struct.thing*, %struct.thing** %s2
