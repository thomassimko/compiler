...
L11:
	...
	%r12 = load %struct.foo*, %struct.foo** %math1
	%r13 = getelementptr %struct.foo , %struct.foo* %r12, i1 0, i32 2
	...
	%r18 = load %struct.foo*, %struct.foo** %math2
	%r19 = getelementptr %struct.foo , %struct.foo* %r18, i1 0, i32 2
	...
	%r23 = getelementptr %struct.foo , %struct.foo* %r22, i1 0, i32 0
	...
	%r28 = getelementptr %struct.foo , %struct.foo* %r27, i1 0, i32 2
	%r29 = load %struct.simple*, %struct.simple** %r28
	%r30 = getelementptr %struct.simple , %struct.simple* %r29, i1 0, i32 0
	...
	%r35 = getelementptr %struct.foo , %struct.foo* %r34, i1 0, i32 2
	...
	%r39 = getelementptr %struct.foo , %struct.foo* %r38, i1 0, i32 0
	%r40 = load i32, i32* %r39
	store i32 %r40, i32* %r37
	%r77 = load i32, i32* %num
...
L13:
	...
	%r45 = getelementptr %struct.foo , %struct.foo* %r44, i1 0, i32 0
	%r46 = load i32, i32* %r45
	%r47 = mul i32 %r43, %r46
	store i32 %r47, i32* %tmp
	%r48 = load i32, i32* %tmp
	%r49 = load %struct.foo*, %struct.foo** %math1
	%r50 = getelementptr %struct.foo , %struct.foo* %r49, i1 0, i32 2
	%r51 = load %struct.simple*, %struct.simple** %r50
	%r52 = getelementptr %struct.simple , %struct.simple* %r51, i1 0, i32 0
	%r53 = load i32, i32* %r52
	%r54 = mul i32 %r48, %r53
	%r55 = load %struct.foo*, %struct.foo** %math2
	%r56 = getelementptr %struct.foo , %struct.foo* %r55, i1 0, i32 0
	%r57 = load i32, i32* %r56
	%r58 = sdiv i32 %r54, %r57
	store i32 %r58, i32* %tmp
	%r59 = load %struct.foo*, %struct.foo** %math2
	%r60 = getelementptr %struct.foo , %struct.foo* %r59, i1 0, i32 2
	%r61 = load %struct.simple*, %struct.simple** %r60
	%r62 = getelementptr %struct.simple , %struct.simple* %r61, i1 0, i32 0
	%r63 = load i32, i32* %r62
	%r64 = load %struct.foo*, %struct.foo** %math1
	%r65 = getelementptr %struct.foo , %struct.foo* %r64, i1 0, i32 0
	...
	%r72 = getelementptr %struct.foo , %struct.foo* %r71, i1 0, i32 0
	%r73 = load i32, i32* %r72
	%r74 = sub i32 %r70, %r73
	store i32 %r74, i32* %tmp
	%r75 = load i32, i32* %num
	%r76 = sub i32 %r75, 1
...
L33:
	...
	%r129 = load i32, i32* %b
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r129)
	%r130 = load i32, i32* %c
	call void @objinstantiation(i32 %r130 )
	%r131 = load i32, i32* %c
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r131)
	%r132 = load i32, i32* %d
	%r133 = load i32, i32* %e
