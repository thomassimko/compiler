...
L2:
	...
	%r0 = load %struct.node** %first
	store %struct.node* %r0, %struct.node** %temp
	%r1 = load %struct.node** %first
...
L4:
	%r5 = load %struct.node** %second
	store %struct.node* %r5, %struct.node** %_retval_
	br label %L3
L5:
	br label %L6
L6:
	%r10 = load %struct.node** %temp
	%r11 = getelementptr %struct.node* %r10, i1 0, i32 1
...
L8:
	...
	%r8 = getelementptr %struct.node* %r7, i1 0, i32 1
	%r9 = load %struct.node** %r8
	store %struct.node* %r9, %struct.node** %temp
	%r16 = load %struct.node** %temp
	%r17 = getelementptr %struct.node* %r16, i1 0, i32 1
...
L9:
	%r22 = load %struct.node** %temp
	%r23 = getelementptr %struct.node* %r22, i1 0, i32 1
	%r24 = load %struct.node** %second
	store %struct.node* %r24, %struct.node** %r23
	%r25 = load %struct.node** %first
	store %struct.node* %r25, %struct.node** %_retval_
	br label %L3
L3:
	%r6 = load %struct.node** %_retval_
	ret %struct.node* %r6
}
...
L11:
	...
	%r30 = getelementptr %struct.node* %r29, i1 0, i32 0
	%r31 = load i32* %toAdd
	store i32 %r31, i32* %r30
	%r32 = load %struct.node** %newNode
	%r33 = getelementptr %struct.node* %r32, i1 0, i32 1
	%r34 = load %struct.node** %list
	store %struct.node* %r34, %struct.node** %r33
	%r35 = load %struct.node** %newNode
	store %struct.node* %r35, %struct.node** %_retval_
	br label %L12
L12:
	%r36 = load %struct.node** %_retval_
	ret %struct.node* %r36
}
...
L17:
	br label %L18
L18:
	%r42 = load %struct.node** %list
	%r43 = getelementptr %struct.node* %r42, i1 0, i32 1
...
L23:
	%r52 = load %struct.node** %list
	%r53 = getelementptr %struct.node* %r52, i1 0, i32 0
	%r54 = load i32* %r53
...
L24:
	br label %L25
L25:
	%r56 = load %struct.node** %list
	%r57 = getelementptr %struct.node* %r56, i1 0, i32 1
...
L33:
	%r72 = load %struct.node** %list
	%r73 = getelementptr %struct.node* %r72, i1 0, i32 0
	%r74 = load i32* %r73
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r74)
	%r75 = load %struct.node** %list
	%r76 = getelementptr %struct.node* %r75, i1 0, i32 1
	%r77 = load %struct.node** %r76
...
L39:
	%r82 = load %struct.tnode** %root
	%r83 = getelementptr %struct.tnode* %r82, i1 0, i32 1
	%r84 = load %struct.tnode** %r83
	call void @treeprint(%struct.tnode* %r84 )
	%r85 = load %struct.tnode** %root
	%r86 = getelementptr %struct.tnode* %r85, i1 0, i32 0
	%r87 = load i32* %r86
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r87)
	%r88 = load %struct.tnode** %root
	%r89 = getelementptr %struct.tnode* %r88, i1 0, i32 2
...
L45:
	%r95 = load %struct.node** %list
	%r96 = getelementptr %struct.node* %r95, i1 0, i32 1
	%r97 = load %struct.node** %r96
	call void @freeList(%struct.node* %r97 )
	%r99 = load %struct.node** %list
...
L51:
	%r105 = load %struct.tnode** %root
	%r106 = getelementptr %struct.tnode* %r105, i1 0, i32 1
	%r107 = load %struct.tnode** %r106
	call void @freeTree(%struct.tnode* %r107 )
	%r108 = load %struct.tnode** %root
	%r109 = getelementptr %struct.tnode* %r108, i1 0, i32 2
	%r110 = load %struct.tnode** %r109
	call void @freeTree(%struct.tnode* %r110 )
	%r112 = load %struct.tnode** %root
...
L57:
	...
	%r122 = getelementptr %struct.tnode* %r121, i1 0, i32 0
	%r123 = load i32* %r122
	store i32 %r123, i32* %r120
	%r124 = load %struct.node** %temp
	%r125 = getelementptr %struct.node* %r124, i1 0, i32 1
	store %struct.node* null, %struct.node** %r125
	%r126 = load %struct.tnode** %root
	%r127 = getelementptr %struct.tnode* %r126, i1 0, i32 1
	%r128 = load %struct.tnode** %r127
	%r129 = call %struct.node* @postOrder(%struct.tnode* %r128 )
	%r130 = load %struct.tnode** %root
	%r131 = getelementptr %struct.tnode* %r130, i1 0, i32 2
	%r132 = load %struct.tnode** %r131
	%r133 = call %struct.node* @postOrder(%struct.tnode* %r132 )
	%r134 = call %struct.node* @concatLists(%struct.node* %r129, %struct.node* %r133 )
	%r135 = load %struct.node** %temp
...
L59:
	...
	br label %L56
L56:
	%r137 = load %struct.node** %_retval_
...
L64:
	...
	%r145 = load %struct.tnode** %temp
	%r146 = getelementptr %struct.tnode* %r145, i1 0, i32 0
	%r147 = load i32* %toAdd
	store i32 %r147, i32* %r146
	%r148 = load %struct.tnode** %temp
	%r149 = getelementptr %struct.tnode* %r148, i1 0, i32 1
	store %struct.tnode* null, %struct.tnode** %r149
	%r150 = load %struct.tnode** %temp
	%r151 = getelementptr %struct.tnode* %r150, i1 0, i32 2
	store %struct.tnode* null, %struct.tnode** %r151
	%r152 = load %struct.tnode** %temp
...
L66:
	...
	%r156 = getelementptr %struct.tnode* %r155, i1 0, i32 0
	%r157 = load i32* %r156
...
L68:
	%r161 = load %struct.tnode** %root
	%r162 = getelementptr %struct.tnode* %r161, i1 0, i32 1
	%r163 = load %struct.tnode** %root
	%r164 = getelementptr %struct.tnode* %r163, i1 0, i32 1
	%r165 = load %struct.tnode** %r164
	%r166 = load i32* %toAdd
	%r167 = call %struct.tnode* @treeadd(%struct.tnode* %r165, i32 %r166 )
	store %struct.tnode* %r167, %struct.tnode** %r162
	br label %L70
L69:
	%r168 = load %struct.tnode** %root
	%r169 = getelementptr %struct.tnode* %r168, i1 0, i32 2
	%r170 = load %struct.tnode** %root
	%r171 = getelementptr %struct.tnode* %r170, i1 0, i32 2
	%r172 = load %struct.tnode** %r171
	%r173 = load i32* %toAdd
	%r174 = call %struct.tnode* @treeadd(%struct.tnode* %r172, i32 %r173 )
	store %struct.tnode* %r174, %struct.tnode** %r169
	br label %L70
L70:
	%r175 = load %struct.tnode** %root
	store %struct.tnode* %r175, %struct.tnode** %_retval_
	br label %L63
L63:
	%r153 = load %struct.tnode** %_retval_
...
L75:
	br label %L76
L76:
	%r184 = load %struct.node** %list
	%r185 = call i32 @get(%struct.node* %r184, i32 0 )
	%r186 = load %struct.node** %list
	...
	%r193 = load %struct.node** %list
	store %struct.node* %r193, %struct.node** %temp
	store i32 0, i32* %i
	%r216 = load %struct.node** %temp
...
L79:
	%r201 = load %struct.node** %greater
	%r202 = load %struct.node** %list
	%r203 = load i32* %i
...
L80:
	...
	br label %L81
L81:
	%r211 = load %struct.node** %temp
	%r212 = getelementptr %struct.node* %r211, i1 0, i32 1
	%r213 = load %struct.node** %r212
	store %struct.node* %r213, %struct.node** %temp
	%r214 = load i32* %i
	%r215 = add i32 %r214, 1
	store i32 %r215, i32* %i
	%r220 = load %struct.node** %temp
...
L82:
	...
	br label %L73
L73:
	%r183 = load %struct.node** %_retval_
...
L84:
	...
	%list = alloca %struct.node*
	store %struct.node* %_P_list, %struct.node** %list
	%r231 = load %struct.node** %list
	call void @printList(%struct.node* %r231 )
	%r232 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r232)
	%r233 = load %struct.node** %list
	call void @printList(%struct.node* %r233 )
	%r234 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r234)
	%r235 = load %struct.node** %list
	call void @printList(%struct.node* %r235 )
	%r236 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r236)
	store %struct.node* null, %struct.node** %_retval_
	br label %L85
L85:
	%r237 = load %struct.node** %_retval_
...
L87:
	...
	%r238 = sub i32 0, 1
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r238)
	%r239 = load %struct.tnode** %root
...
L89:
	%r243 = load %struct.tnode** %root
	%r244 = getelementptr %struct.tnode* %r243, i1 0, i32 0
	%r245 = load i32* %r244
	%r246 = load i32* %target
...
L94:
	...
	%r252 = getelementptr %struct.tnode* %r251, i1 0, i32 1
	%r253 = load %struct.tnode** %r252
	%r254 = load i32* %target
...
L97:
	br label %L98
L98:
	%r260 = load %struct.tnode** %root
	%r261 = getelementptr %struct.tnode* %r260, i1 0, i32 2
	%r262 = load %struct.tnode** %r261
	%r263 = load i32* %target
...
L108:
	...
	%r277 = load %struct.node** %temp
	%r278 = getelementptr %struct.node* %r277, i1 0, i32 0
	%r279 = load %struct.tnode** %root
	%r280 = getelementptr %struct.tnode* %r279, i1 0, i32 0
	%r281 = load i32* %r280
	store i32 %r281, i32* %r278
	%r282 = load %struct.node** %temp
	%r283 = getelementptr %struct.node* %r282, i1 0, i32 1
	store %struct.node* null, %struct.node** %r283
	%r284 = load %struct.tnode** %root
	%r285 = getelementptr %struct.tnode* %r284, i1 0, i32 1
	%r286 = load %struct.tnode** %r285
	%r287 = call %struct.node* @inOrder(%struct.tnode* %r286 )
	%r288 = load %struct.node** %temp
	%r289 = load %struct.tnode** %root
	%r290 = getelementptr %struct.tnode* %r289, i1 0, i32 2
...
L110:
	br label %L107
L107:
	%r295 = load %struct.node** %_retval_
...
L114:
	...
	store i32 %_P_target, i32* %target
	%r297 = sub i32 0, 1
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r297)
	%r298 = load %struct.tnode** %root
...
L116:
	%r302 = load %struct.tnode** %root
	%r303 = getelementptr %struct.tnode* %r302, i1 0, i32 0
	%r304 = load i32* %r303
	%r305 = load i32* %target
...
L120:
	br label %L121
L121:
	%r310 = load i32* %target
	%r311 = load %struct.tnode** %root
	%r312 = getelementptr %struct.tnode* %r311, i1 0, i32 0
	%r313 = load i32* %r312
...
L123:
	%r317 = load %struct.tnode** %root
	%r318 = getelementptr %struct.tnode* %r317, i1 0, i32 1
	%r319 = load %struct.tnode** %r318
	%r320 = load i32* %target
	%r321 = call i32 @bintreesearch(%struct.tnode* %r319, i32 %r320 )
	store i32 %r321, i32* %_retval_
	br label %L115
L124:
	%r323 = load %struct.tnode** %root
	%r324 = getelementptr %struct.tnode* %r323, i1 0, i32 2
	%r325 = load %struct.tnode** %r324
	%r326 = load i32* %target
...
L131:
	%r330 = load %struct.tnode** %root
	%r331 = load %struct.node** %list
	%r332 = load i32* %i
...
L132:
	%r349 = load %struct.tnode** %root
	store %struct.tnode* %r349, %struct.tnode** %_retval_
	br label %L130
L130:
	%r350 = load %struct.tnode** %_retval_
...
L134:
	...
	%r354 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r354)
	%r355 = load %struct.tnode** %root
	%r356 = call %struct.node* @inOrder(%struct.tnode* %r355 )
	store %struct.node* %r356, %struct.node** %inList
	%r357 = load %struct.node** %inList
	call void @printList(%struct.node* %r357 )
	%r358 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r358)
	%r359 = load %struct.node** %inList
	...
	%r362 = load %struct.node** %postList
	call void @printList(%struct.node* %r362 )
	%r363 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r363)
	%r364 = load %struct.node** %postList
	call void @freeList(%struct.node* %r364 )
	%r365 = load %struct.tnode** %root
	%r366 = call i32 @treesearch(%struct.tnode* %r365, i32 0 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r366)
	%r367 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r367)
	%r368 = load %struct.tnode** %root
	%r369 = call i32 @treesearch(%struct.tnode* %r368, i32 10 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r369)
	%r370 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r370)
	%r371 = load %struct.tnode** %root
	%r372 = sub i32 0, 2
	%r373 = call i32 @treesearch(%struct.tnode* %r371, i32 %r372 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r373)
	%r374 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r374)
	%r375 = load %struct.tnode** %root
	%r376 = call i32 @treesearch(%struct.tnode* %r375, i32 2 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r376)
	%r377 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r377)
	%r378 = load %struct.tnode** %root
	%r379 = call i32 @treesearch(%struct.tnode* %r378, i32 3 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r379)
	%r380 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r380)
	%r381 = load %struct.tnode** %root
	%r382 = call i32 @treesearch(%struct.tnode* %r381, i32 9 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r382)
	%r383 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r383)
	%r384 = load %struct.tnode** %root
	%r385 = call i32 @treesearch(%struct.tnode* %r384, i32 1 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r385)
	%r386 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r386)
	%r387 = load %struct.tnode** %root
	%r388 = call i32 @bintreesearch(%struct.tnode* %r387, i32 0 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r388)
	%r389 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r389)
	%r390 = load %struct.tnode** %root
	%r391 = call i32 @bintreesearch(%struct.tnode* %r390, i32 10 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r391)
	%r392 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r392)
	%r393 = load %struct.tnode** %root
	%r394 = sub i32 0, 2
	%r395 = call i32 @bintreesearch(%struct.tnode* %r393, i32 %r394 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r395)
	%r396 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r396)
	%r397 = load %struct.tnode** %root
	%r398 = call i32 @bintreesearch(%struct.tnode* %r397, i32 2 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r398)
	%r399 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r399)
	%r400 = load %struct.tnode** %root
	%r401 = call i32 @bintreesearch(%struct.tnode* %r400, i32 3 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r401)
	%r402 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r402)
	%r403 = load %struct.tnode** %root
	%r404 = call i32 @bintreesearch(%struct.tnode* %r403, i32 9 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r404)
	%r405 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r405)
	%r406 = load %struct.tnode** %root
	%r407 = call i32 @bintreesearch(%struct.tnode* %r406, i32 1 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r407)
	%r408 = sub i32 0, 999
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r408)
	%r409 = load %struct.tnode** %root
...
L140:
	br label %L141
L141:
	%r415 = load %struct.node** %src
	%r416 = getelementptr %struct.node* %r415, i1 0, i32 0
	%r417 = load i32* %r416
	%r418 = call %struct.node* @add(%struct.node* null, i32 %r417 )
	%r419 = load %struct.node** %src
	%r420 = getelementptr %struct.node* %r419, i1 0, i32 1
	%r421 = load %struct.node** %r420
	...
	br label %L138
L138:
	%r414 = load %struct.node** %_retval_
...
L147:
	%r446 = load %struct.node** %myList
	call void @freeList(%struct.node* %r446 )
	%r447 = load %struct.node** %copyList1
	call void @freeList(%struct.node* %r447 )
	%r448 = load %struct.node** %copyList2
	call void @freeList(%struct.node* %r448 )
	store i32 0, i32* %_retval_
	br label %L145
L145:
	%r449 = load i32* %_retval_
	ret i32 %r449
}
