...
L2:
	...
	%r5 = load %struct.linkedNums** %prevNode
	%r6 = getelementptr %struct.linkedNums* %r5, i1 0, i32 1
	%r7 = load i32* %cur
	store i32 %r7, i32* %r6
	%r8 = load %struct.linkedNums** %prevNode
	%r9 = getelementptr %struct.linkedNums* %r8, i1 0, i32 0
...
L4:
	...
	%r24 = load %struct.linkedNums** %curNode
	%r25 = getelementptr %struct.linkedNums* %r24, i1 0, i32 1
	%r26 = load i32* %cur
	store i32 %r26, i32* %r25
	%r27 = load %struct.linkedNums** %curNode
	%r28 = getelementptr %struct.linkedNums* %r27, i1 0, i32 0
	%r29 = load %struct.linkedNums** %prevNode
...
L5:
	%r42 = load %struct.linkedNums** %curNode
	store %struct.linkedNums* %r42, %struct.linkedNums** %_retval_
	br label %L3
L3:
	%r43 = load %struct.linkedNums** %_retval_
...
L7:
	...
	%r54 = load %struct.linkedNums** %nums
...
L20:
	%nums = alloca %struct.linkedNums*
	store %struct.linkedNums* %_P_nums, %struct.linkedNums** %nums
	%r97 = load %struct.linkedNums** %nums
...
L22:
	%r90 = load %struct.linkedNums** %nums
	%r91 = getelementptr %struct.linkedNums* %r90, i1 0, i32 1
	%r92 = load i32* %r91
	%r93 = call i32 @approxSqrt(i32 %r92 )
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r93)
	%r94 = load %struct.linkedNums** %nums
	%r95 = getelementptr %struct.linkedNums* %r94, i1 0, i32 0
	%r96 = load %struct.linkedNums** %r95
...
L28:
	...
	%r109 = getelementptr %struct.linkedNums* %r108, i1 0, i32 1
	%r110 = load i32* %r109
	store i32 %r110, i32* %min
	%r111 = load %struct.linkedNums** %nums
	%r112 = getelementptr %struct.linkedNums* %r111, i1 0, i32 1
	%r113 = load i32* %r112
	...
	br label %L30
L29:
	%r115 = load %struct.linkedNums** %nums
	%r116 = getelementptr %struct.linkedNums* %r115, i1 0, i32 1
	%r117 = load i32* %r116
	%r118 = load i32* %min
...
L30:
	%r135 = load %struct.linkedNums** %nums
	%r136 = getelementptr %struct.linkedNums* %r135, i1 0, i32 0
	%r137 = load %struct.linkedNums** %r136
	store %struct.linkedNums* %r137, %struct.linkedNums** %nums
	%r142 = load %struct.linkedNums** %nums
...
L31:
	%r122 = load %struct.linkedNums** %nums
	%r123 = getelementptr %struct.linkedNums* %r122, i1 0, i32 1
	%r124 = load i32* %r123
	store i32 %r124, i32* %min
	br label %L33
L32:
	%r125 = load %struct.linkedNums** %nums
	%r126 = getelementptr %struct.linkedNums* %r125, i1 0, i32 1
	%r127 = load i32* %r126
	%r128 = load i32* %max
...
L33:
	br label %L30
L34:
	%r132 = load %struct.linkedNums** %nums
	%r133 = getelementptr %struct.linkedNums* %r132, i1 0, i32 1
	%r134 = load i32* %r133
...
L37:
	%r146 = load i32* %min
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r146)
	%r147 = load i32* %max
	call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.println, i32 0, i32 0), i32 %r147)
	br label %L26
L26:
	ret void
}
...
L39:
	...
	%r151 = load %struct.linkedNums** %nums
