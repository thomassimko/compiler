...
L10:
	...
	%r158 = load i32, i32* %number
	%r159 = icmp sgt i32 %r158, 0
	%r160 = zext i1 %r159 to i32
	%r161 = trunc i32 %r160 to i1
	br i1 %r161, label %L12, label %L13

L12:
	%r162 = load i32, i32* %total
	%r163 = load i32, i32* %number
	%r164 = add i32 %r162, %r163
	store i32 %r164, i32* %total
	%r165 = load i32, i32* %number
	%r166 = sub i32 %r165, 1
	store i32 %r166, i32* %number
...
L33:
	...
	store i32 0, i32* %i
	%r464 = load i32, i32* %i
	%r465 = icmp slt i32 %r464, 1000000
	%r466 = zext i1 %r465 to i32
	%r467 = trunc i32 %r466 to i1
	br i1 %r467, label %L35, label %L36
...
L35:
	...
	store i32 %r472, i32* %g
	%r473 = load i32, i32* %c
	%r474 = load i32, i32* %d
	%r475 = add i32 %r473, %r474
	%r476 = load i32, i32* %g
	%r477 = add i32 %r475, %r476
	store i32 %r477, i32* %h
	%r478 = load i32, i32* %i
	%r479 = add i32 %r478, 1
	store i32 %r479, i32* %i
	%r480 = load i32, i32* %i
...
L62:
	...
	store i32 2, i32* %b
	%r552 = load i32, i32* %a
	%r553 = icmp slt i32 %r552, 1000000
	%r554 = zext i1 %r553 to i32
	%r555 = trunc i32 %r554 to i1
	br i1 %r555, label %L64, label %L65

L64:
	%r556 = load i32, i32* %b
	%r557 = icmp eq i32 %r556, 2
	%r558 = zext i1 %r557 to i32
	%r559 = trunc i32 %r558 to i1
	br i1 %r559, label %L66, label %L67

L66:
	%r560 = load i32, i32* %a
	%r561 = add i32 %r560, 1
	store i32 %r561, i32* %a
	br label %L68
L67:
	%r562 = load i32, i32* %a
	%r563 = add i32 %r562, 2
	store i32 %r563, i32* %a
	br label %L68
L68:
	%r564 = load i32, i32* %a
	...
	br i1 %r567, label %L64, label %L65
...
L70:
	...
	store i32 0, i32* %sum
	%r570 = load i32, i32* %i
	%r571 = load i32, i32* %number
	%r572 = icmp slt i32 %r570, %r571
	%r573 = zext i1 %r572 to i32
	%r574 = trunc i32 %r573 to i1
	br i1 %r574, label %L72, label %L73
...
L72:
	...
	store i32 %r577, i32* %d
	%r578 = load i32, i32* %d
	%r579 = load i32, i32* %c
	%r580 = add i32 %r578, %r579
	store i32 %r580, i32* %e
	%r581 = load i32, i32* %sum
	%r582 = load i32, i32* %e
	%r583 = add i32 %r581, %r582
	store i32 %r583, i32* %sum
	%r584 = load i32, i32* %i
	%r585 = mul i32 %r584, 2
	store i32 %r585, i32* %i
	%r586 = load i32, i32* %i
	%r587 = sdiv i32 %r586, 2
	store i32 %r587, i32* %i
	%r588 = load i32, i32* %i
	%r589 = mul i32 3, %r588
	store i32 %r589, i32* %i
	%r590 = load i32, i32* %i
	%r591 = sdiv i32 %r590, 3
	store i32 %r591, i32* %i
	%r592 = load i32, i32* %i
	%r593 = mul i32 %r592, 4
	store i32 %r593, i32* %i
	%r594 = load i32, i32* %i
	%r595 = sdiv i32 %r594, 4
	store i32 %r595, i32* %i
	%r596 = load i32, i32* %i
	%r597 = add i32 %r596, 1
	store i32 %r597, i32* %i
	%r598 = load i32, i32* %i
	%r599 = load i32, i32* %number
	%r600 = icmp slt i32 %r598, %r599
	%r601 = zext i1 %r600 to i32
	%r602 = trunc i32 %r601 to i1
	br i1 %r602, label %L72, label %L73
...
L75:
	...
	store i32 0, i32* %i
	%r606 = load i32, i32* %i
	%r607 = load i32, i32* %number
	%r608 = icmp slt i32 %r606, %r607
	%r609 = zext i1 %r608 to i32
	%r610 = trunc i32 %r609 to i1
	br i1 %r610, label %L77, label %L78

L77:
	%r611 = load i32, i32* %result
	%r612 = load i32, i32* %previous
	%r613 = add i32 %r611, %r612
	store i32 %r613, i32* %sum
	%r614 = load i32, i32* %result
	store i32 %r614, i32* %previous
	%r615 = load i32, i32* %sum
	store i32 %r615, i32* %result
	%r616 = load i32, i32* %i
	%r617 = add i32 %r616, 1
	store i32 %r617, i32* %i
	%r618 = load i32, i32* %i
	%r619 = load i32, i32* %number
	%r620 = icmp slt i32 %r618, %r619
	%r621 = zext i1 %r620 to i32
	%r622 = trunc i32 %r621 to i1
	br i1 %r622, label %L77, label %L78
...
L80:
	...
	br i1 %r632, label %L82, label %L83
...
L86:
	...
	%r643 = load i32, i32* @.read_scratch
	store i32 %r643, i32* %input
	store i32 1, i32* %i
	%r644 = load i32, i32* %i
	%r645 = load i32, i32* %input
	%r646 = icmp slt i32 %r644, %r645
	%r647 = zext i1 %r646 to i32
	%r648 = trunc i32 %r647 to i1
	br i1 %r648, label %L88, label %L89

L88:
	%r649 = call i32 @constantFolding()
	...
	%r651 = call i32 @constantPropagation()
	...
	%r653 = call i32 @deadCodeElimination()
	...
	%r655 = call i32 @interProceduralOptimization()
	...
	%r657 = call i32 @commonSubexpressionElimination()
	...
	%r661 = call i32 @doubleIf()
	store i32 %r661, i32* %result
	%r662 = load i32, i32* %result
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r662)
	%r663 = call i32 @integerDivide()
	...
	%r668 = sdiv i32 %r667, 1000
	%r669 = call i32 @tailRecursion(i32 %r668 )
	store i32 %r669, i32* %result
	%r670 = load i32, i32* %result
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r670)
	%r671 = call i32 @unswitching()
	store i32 %r671, i32* %result
	%r672 = load i32, i32* %result
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r672)
	%r673 = load i32, i32* %input
	%r674 = call i32 @randomCalculation(i32 %r673 )
	store i32 %r674, i32* %result
	%r675 = load i32, i32* %result
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r675)
	%r676 = load i32, i32* %input
	%r677 = sdiv i32 %r676, 5
	%r678 = call i32 @iterativeFibonacci(i32 %r677 )
	store i32 %r678, i32* %result
	%r679 = load i32, i32* %result
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r679)
	%r680 = load i32, i32* %input
	%r681 = sdiv i32 %r680, 1000
	%r682 = call i32 @recursiveFibonacci(i32 %r681 )
	store i32 %r682, i32* %result
	%r683 = load i32, i32* %result
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.println, i32 0, i32 0), i32 %r683)
	%r684 = load i32, i32* %i
	%r685 = add i32 %r684, 1
	store i32 %r685, i32* %i
	%r686 = load i32, i32* %i
	%r687 = load i32, i32* %input
	%r688 = icmp slt i32 %r686, %r687
	%r689 = zext i1 %r688 to i32
	%r690 = trunc i32 %r689 to i1
	br i1 %r690, label %L88, label %L89
